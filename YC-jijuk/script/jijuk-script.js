function loadImages()
{
    ...
    for (let i = 1; i <= totalImages; i++)
    {
        ...
        //let imgUrl = `http://www.dggis.kr/Youngcheon/YC-jijuk/jijuk-img/${encodedCode}_${i.toString().padStart(2, '0')}.jpg`;
        let imgUrl = `https://nexjijuk.github.io/Yeongcheon/YC-jijuk/jijuk-img/${encodedCode}_${i.toString().padStart(2, '0')}.jpg`;
        img.src = imgUrl;
